...
def regeneratePassword(index, details, masterusername, privateKey, publicKey): 
    if index == -1:
        ...
        editPasswordFile('passwords.csv', details, masterusername, privateKey, publicKey )

    return details

def editPasswordFile(file, details, masterusername, privateKey, publicKey ): 
    ...
    #add the currently logged in user's details to the array
    alldetails = details + alldetails

    #write the details to file
    DataFile = open(file, 'w')
    for i in range(len(alldetails)):
        DataFile.write(alldetails[i].getUsername() + "," + str(encryptMessage(alldetails[i].getPassword(),publicKey)) + "," + alldetails[i].getService() + "," + str(alldetails[i].getStrength())+ "," + str(len(alldetails[i].getPassword()))+"\n")  
    DataFile.close() 
